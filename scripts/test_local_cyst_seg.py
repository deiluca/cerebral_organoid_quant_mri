...
def create_conf_files_test(create_yml=False):
    ...
    for org in range(1, 10):
        ...
        ref_config['loaders']['test']['file_paths'] = [f'/home/ws/oc9627/Dokumente/MRT_segmentations_cysts/annotations_15_12_2022_34_orgs_with_cyst_sizes_greater_1000/h5_files/LOO_org{org}/test']
